...
class ContributorsControllerTest < ActionController::TestCase
  ...
  test "should create contributor" do
    assert_difference('Contributor.count') do
      post :create, contributor: { event_product_id: @contributor.event_product_id, given_price: @contributor.given_price, user_id: @contributor.user_id }
    end
  ...
  test "should update contributor" do
    patch :update, id: @contributor, contributor: { event_product_id: @contributor.event_product_id, given_price: @contributor.given_price, user_id: @contributor.user_id }
    assert_redirected_to contributor_path(assigns(:contributor))
  end
